...
const MidiPlayer = () => {
  ...
  // List of fake MIDI song titles (we'll use mp3 in reality)
  const songs: Song[] = [
    { title: "Y2K Vibes.mid", url: "/sounds/y2k-vibes.mp3" },
    { title: "Cyber Dreams.mid", url: "/sounds/cyber-dreams.mp3" },
    { title: "Digital Wonderland.mid", url: "/sounds/digital-wonderland.mp3" },
    { title: "Internet Explorer.mid", url: "/sounds/internet-explorer.mp3" }
  ]
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <span style={{ fontSize: '11px' }}>🎵 MIDI Player</span>
        </div>
      ...
      <div style={{ padding: '10px' }}>
        ...
        <div style={{ 
          ...
          BubbleNet 2000 Midi Collection
        </div>
      </div>
    </div>
  )
